...
//        memoriaBag.get(2).setCarrier(1);
    ...
    public void initPlotBattle(){
        ...
        felicia.fiveStarMinATK = 2159;
        felicia.fiveStarMaxATK = 8700;
        ...
        felicia.initialEffectList.add(new Effect("攻击力UP", 40, 999, 100, 0));
        ...
        kako.fiveStarMinATK = 1616;
        kako.fiveStarMaxATK = 6609;
        ...
        ayame.fiveStarMinATK = 2139;
        ayame.fiveStarMaxATK = 8556;
        ...
        ayame.initialEffectList.add(new Effect("暴击", 0, 999, 50, 1));
