...
public:
    ...
    */
    ...
    void setCharacter(std::string char0id, std::string char0motion, std::string char0face, std::string char1id, std::string char1motion, std::string char1face, std::string char2id, std::string char2motion, std::string char2face);
